            ...
            <div className="container">
                <div className="tuition-wrap">
                  ...
                  <div className="tuition-fee-table" >
                    <h4 className="my-4" data-aos="fade-right">Faculty of Science and Information Technology</h4>
                    ...
                    <h4 className="my-4" data-aos="fade-right">Master Of Business Administration</h4>
                    <div className="table-responsive" data-aos="fade-right">
                        <table className="table table-light">
                            <thead>
                                <tr>
                  ...
                  <div className="mt-4 mb-2" data-aos="fade-right">
